...
public class Parser {
    ...
    static {
        commandSpecs.add(new CommandSpec("add", "add n/NAME q/QUANTITY [sem/SEMESTER] [life/LIFESPAN]", AddCommand::parse));
        ...
        commandSpecs.add(new CommandSpec("setstatus", "setstatus n/NAME q/QUANTITY s/STATUS " + "or setstatus INDEX q/QUANTITY s/STATUS", SetStatusCommand::parse));
        ...
        commandSpecs.add(new CommandSpec("delete", "delete n/NAME q/QUANTITY s/STATUS " + "or delete INDEX q/QUANTITY s/STATUS", DeleteCommand::parse));
        commandSpecs.add(new CommandSpec("help", "help", fullCommand -> new HelpCommand()));
        commandSpecs.add(new CommandSpec("report", "report aging [AY[YYYY]/[YY] Sem[1/2]]", ReportCommand::parse));
    }
